...
import { DataProfilingDashboard } from "@/components/data-profiling-dashboard"
    ...
    return (
      <div className="flex items-center justify-center min-h-[400px]">
        <div className="text-center">
          ...
          <p className="text-sm text-muted-foreground">Initializing data profiling...</p>
        </div>
      </div>
    )
  }
      ...
      <div className="container mx-auto p-6">
        <Alert>
          ...
          <AlertDescription className="mt-2">
            You need to upload a parquet file before you can profile data.
            <div className="mt-4">
  ...
  return (
    <div className="container mx-auto p-6">
      <div className="mb-6">
        ...
        <p className="text-muted-foreground mt-2">Comprehensive analysis of your data quality and column statistics</p>
      </div>

      <DataProfilingDashboard connection={connection} />
    </div>
  )
}
